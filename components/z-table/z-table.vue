<template>
    <view class="z-table">
        <view
            class="z-table-main"
            :style="compluteHeight"
        >
            <view
                v-if="!tableLoaded && !tableData"
                ...
                <view class="z-table-pack">
                    <view class="z-table-title">
                        ...
                        >
                            {{ item.title }}
                            <view
                                v-if="item.hasOwnProperty('key') && item.hasOwnProperty('sort') && tableData.length"
                                class="sort"
                            >
                                <view
                                    class="up-arrow"
                                    :class="{ action: nowSortKey == item.key && sortType == 'asc' }"
                                ></view>
                                <view
                                    class="down-arrow"
                                    :class="{ action: nowSortKey == item.key && sortType == 'desc' }"
                                ></view>
                            </view>
                        </view>
                    </view>
